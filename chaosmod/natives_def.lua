...
function GET_CURRENT_TV_SHOW_PLAY_TIME()
   return _invoke(0xDD3AA743AB7D4D75,_i)
end
...
function _ENABLE_DRAG_RACE_STATIONARY_WARNING_SOUNDS(vehicle,enable)
   _invoke(0xBEFB80290414FD4F,_,vehicle,enable)
end
...
function _GET_THIRD_PERSON_CAM_MIN_ORBIT_DISTANCE_SPRING()
   return _invoke(0xBC456FB703431785,_f)
end

function _GET_THIRD_PERSON_CAM_MAX_ORBIT_DISTANCE_SPRING()
   return _invoke(0xD4592A16D36673ED,_f)
end
...
function SET_ENTITY_HEALTH(entity,health,instigator,weaponType)
   _invoke(0x6B76DC1F3AE6E6A3,_,entity,health,instigator,weaponType)
end
...
function _SET_PARTICLE_FX_LOOPED_CAMERA_BIAS(ptfxHandle,p1)
   _invoke(0x4100BF0346A8D2C3,_,ptfxHandle,p1)
end
...
function _START_VEHICLE_PARTICLE_FX_LOOPED(vehicle,effectName,frontBack,leftRight,localOnly)
   return _invoke(0xDF269BE2909E181A,_i,vehicle,effectName,frontBack,leftRight,localOnly)
end
...
function _FORCE_ALLOW_SNOW_FOOT_VFX_ON_ICE(toggle)
   _invoke(0xA342A3763B3AFB6C,_,toggle)
end
...
function _FORCE_GROUND_SNOW_PASS(toggle)
   _invoke(0x6E9EF3A33C8899F8,_,toggle)
end
...
function _SET_TV_CHANNEL_PLAYLIST_DIRTY(tvChannel,p1)
   _invoke(0xEE831F15A8D0D94A,_,tvChannel,p1)
end
...
function _USE_VEHICLE_TARGETING_RETICULE_ON_VEHICLES(enable)
   _invoke(0x1BC0EA2912708625,_,enable)
end
...
function SET_TEXT_LINE_HEIGHT_MULT(lineHeightMult)
   _invoke(0x9F4624F76E6953D1,_,lineHeightMult)
end
...
function _SET_BLIP_GPS_ROUTE_DISPLAY_DISTANCE(blip,blipChangeParam46,blipChangeParam47)
   _invoke(0x25D984CFB64ED6DE,_,blip,blipChangeParam46,blipChangeParam47)
end
...
function _SET_CONTENT_PROP_TYPE(model,type)
   _invoke(0xBA4583AF4C678A9B,_,model,type)
end

function _GET_CONTENT_PROP_TYPE(model)
   return _invoke(0x8BAF8AD59F47AAFC,_i,model)
end
...
function _NETWORK_SPENT_GENERIC(price,p1,p2,stat,spent,p5,p6,data)
   _invoke(0x2803B027479FB640,_,price,p1,p2,stat,spent,p5,p6,data)
end

function _NETWORK_EARN_GENERIC(amount,earn,p2,p3,data)
   _invoke(0xBF7B5BB7ED890380,_,amount,earn,p2,p3,data)
end

function _NETWORK_CLEAR_TRANSACTION_TELEMETRY_NONCE()
   _invoke(0xE03B9F95556E48E9,_)
end
...
function _NETWORK_HAVE_PLATFORM_COMMUNICATION_PRIVILEGES()
   return _invoke(0xE1E02509169C124E,_b)
end
...
function _NETWORK_SESSION_LEAVE_INCLUDING_REASON(leaveFlags,leaveReason)
   return _invoke(0xE0128328CF1FD9F4,_b,leaveFlags,leaveReason)
end
...
function NETWORK_SESSION_GET_UNIQUE_CREW_LIMIT()
   return _invoke(0xCDC936BF35EDCB73,_i)
end
...
function _NETWORK_IS_AMERICAS_VERSION()
   return _invoke(0x0292BD7F3766CEBC,_b)
end
...
function _NETWORK_DOES_COMMUNICATION_GROUP_EXIST(communicationType)
   return _invoke(0xDBDF80673BBA3D65,_b,communicationType)
end

function _NETWORK_GET_COMMUNICATION_GROUP_FLAGS(communicationType)
   return _invoke(0x40DF02F371F40883,_i,communicationType)
end

function _NETWORK_SET_COMMUNICATION_GROUP_FLAGS(communicationType,communicationGroupFlag)
   _invoke(0xE549F846DE7D32D5,_,communicationType,communicationGroupFlag)
end
...
function SET_NETWORK_ID_VISIBLE_IN_CUTSCENE_REMAIN_HACK(p0,p1,p2)
   _invoke(0x76B3F29D3F967692,_,p0,p1,p2)
end
...
function UGC_HAS_PERMISSION_TO_WRITE()
   return _invoke(0xC33E7CBC06EC1A8D,_b)
end
...
function _NETWORK_HAS_ROS_PRIVILEGE_MP_TEXT_COMMUNICATION()
   return _invoke(0xD9719341663C385F,_b)
end

function _NETWORK_HAS_ROS_PRIVILEGE_MP_VOICE_COMMUNICATION()
   return _invoke(0x8956A309BE90057C,_b)
end
...
function SET_OBJECT_TARGETTABLE(object,targettable,p2)
   _invoke(0x8A7391690F5AFD81,_,object,targettable,p2)
end
...
function _HAS_PED_CLEAR_LOS_TO_ENTITY(ped,entity,x,y,z,p5,p6,p7)
   return _invoke(0xA32ABFEB2A03B306,_b,ped,entity,x,y,z,p5,p6,p7)
end
...
function APPLY_DAMAGE_TO_PED(ped,damageAmount,p2,p3,weaponType)
   _invoke(0x697157CED63F18D4,_,ped,damageAmount,p2,p3,weaponType)
end
...
function ADD_SCENARIO_BLOCKING_AREA(x1,y1,z1,x2,y2,z2,p6,p7,p8,p9,p10)
   return _invoke(0x1B5C85C612E5256E,_i,x1,y1,z1,x2,y2,z2,p6,p7,p8,p9,p10)
end
...
function GET_PLAYER_TARGETING_MODE()
   return _invoke(0x875BDD898B99C8CE,_i)
end
...
function _SEND_TU_SCRIPT_EVENT_NEW(eventGroup,eventData,eventDataSize,playerBits,eventType)
   _invoke(0x71A6F836422FDD2B,_,eventGroup,eventData,eventDataSize,playerBits,eventType)
end
...
function _PLAYSTATS_FLOW_MEDIUM(x,y,z,interiorAction,p4,p5)
   _invoke(0xC4493521BAA12CCE,_,x,y,z,interiorAction,p4,p5)
end
...
function PLAYSTATS_ACTIVITY_DONE(p0,activityId,p2)
   _invoke(0xA071E0ED98F91286,_,p0,activityId,p2)
end
...
function _PLAYSTATS_SHOPMENU_NAV(p0,p1,p2,p3)
   _invoke(0xF96E9EA876D9DC92,_,p0,p1,p2,p3)
end
...
function START_BEING_BOSS(p0,p1,p2)
   _invoke(0x3EBEAC6C3F81F6BD,_,p0,p1,p2)
end
...
function PLAYSTATS_FM_MISSION_END(p0,p1,p2,p3)
   _invoke(0x46A70777BE6CEAB9,_,p0,p1,p2,p3)
end
...
function _PLAYSTATS_ALERT(data)
   _invoke(0x5649CA22AF74E019,_,data)
end
...
function TASK_ENTER_VEHICLE(ped,vehicle,timeout,seat,speed,flag,overrideEntryClipsetName,p7)
   _invoke(0xC20E50AA46D09CA8,_,ped,vehicle,timeout,seat,speed,flag,overrideEntryClipsetName,p7)
end
...
function TASK_RAPPEL_DOWN_WALL_USING_CLIPSET_OVERRIDE(ped,x1,y1,z1,x2,y2,z2,minZ,ropeHandle,clipSet,p10,p11)
   _invoke(0xEAF66ACDDC794793,_,ped,x1,y1,z1,x2,y2,z2,minZ,ropeHandle,clipSet,p10,p11)
end
...
function _SET_SCRIPT_TASK_ENABLE_COLLISION_ON_NETWORK_CLONE_WHEN_FIXED(ped,enable)
   _invoke(0x32F6EEF031F943DC,_,ped,enable)
end
...
function _SET_VEHICLE_MAX_LAUNCH_ENGINE_REVS(vehicle,modifier)
   _invoke(0x5AE614ECA5FDD423,_,vehicle,modifier)
end

function _GET_VEHICLE_THROTTLE(vehicle)
   return _invoke(0x92D96892FC06AF22,_f,vehicle)
end
...
function _GET_VEHICLE_MODEL_NUM_DRIVE_GEARS(vehicleModel)
   return _invoke(0x61F02E4E9A7A61EA,_i,vehicleModel)
end

function _GET_VEHICLE_MAX_DRIVE_GEAR_COUNT(vehicle)
   return _invoke(0x24910C3D66BA770D,_i,vehicle)
end

function _GET_VEHICLE_CURRENT_DRIVE_GEAR(vehicle)
   return _invoke(0x56185A25D45A0DCD,_i,vehicle)
end

function _GET_VEHICLE_CURRENT_REV_RATIO(vehicle)
   return _invoke(0xF9DDA40BC293A61E,_f,vehicle)
end
...
function _SET_ATTACHED_VEHICLE_TO_TOW_TRUCK_ARM(towTruck,vehicle)
   _invoke(0x48BD57D0DD17786A,_,towTruck,vehicle)
end
...
function _SET_TRANSMISSION_REDUCED_GEAR_RATIO(vehicle,toggle)
   _invoke(0x337EF33DA3DDB990,_,vehicle,toggle)
end

function _GET_VEHICLE_DESIRED_DRIVE_GEAR(vehicle)
   return _invoke(0xFD8CE53356B5D745,_i,vehicle)
end
...
function _SET_VEHICLE_USE_HORN_BUTTON_FOR_NITROUS(toggle)
   _invoke(0x1980F68872CC2C3D,_,toggle)
end
...
function SET_NITROUS_IS_ACTIVE(vehicle,enabled)
   _invoke(0x465EEA70AF251045,_,vehicle,enabled)
end

function _SET_OVERRIDE_TRACTION_LOSS_MULTIPLIER(vehicle,modifier)
   _invoke(0xAFD262ACCA64479A,_,vehicle,modifier)
end

function _SET_DRIFT_SLIP_ANGLE_LIMITS(vehicle,durationScalar,amplitudeScalar,slipAngleLimit)
   _invoke(0xDAF4C98C18AC6F06,_,vehicle,durationScalar,amplitudeScalar,slipAngleLimit)
end

function _SET_MINIMUM_TIME_BETWEEN_GEAR_SHIFTS(vehicle,time)
   _invoke(0x16CFBC5E7EB32861,_,vehicle,time)
end

function FULLY_CHARGE_NITROUS(vehicle)
   _invoke(0x1A2BCC8C636F9226,_,vehicle)
end

function _GET_REMAINING_NITROUS_DURATION(vehicle)
   return _invoke(0xBEC4B8653462450E,_f,vehicle)
end

function IS_NITROUS_ACTIVE(vehicle)
   return _invoke(0x491E822B2C464FE4,_b,vehicle)
end

function CLEAR_NITROUS(vehicle)
   _invoke(0xC889AE921400E1ED,_,vehicle)
end
...
function APPLY_EMP_EFFECT(vehicle)
   _invoke(0x249249D74F813EB2,_,vehicle)
end
...
function _SET_ALLOW_COLLISION_WHEN_IN_VEHICLE(vehicle,toggle)
   _invoke(0x27D27223E8EF22ED,_,vehicle,toggle)
end

function _IS_VEHICLE_GEN9_EXCLUSIVE_MODEL(vehicleModel)
   return _invoke(0x6638C0F19DE692FE,_b,vehicleModel)
end

function _GET_VEHICLE_MAX_EXHAUST_BONE_COUNT()
   return _invoke(0x3EE18B00CD86C54F,_i)
end

function _GET_VEHICLE_EXHAUST_BONE(vehicle,index,boneIndex,axisX)
   return _invoke(0xE728F090D538CB18,_b,vehicle,index,boneIndex,axisX)
end
...
function _SET_WEAPON_PED_DAMAGE_MODIFIER(weapon,damageModifier)
   _invoke(0x1091922715B68DF0,_,weapon,damageModifier)
end
